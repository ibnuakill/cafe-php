  ...
  <div class="container">
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary" name="tambah" onclick="return confirm('Apakah anda yakin ingin menambah menu ini?')">Tambah</button>
      ...
      if (isset($_POST['tambah'])) {
        ...
        $stok = !empty($_POST['stok']) ? $_POST['stok'] : 0; // Nilai default 0
        $harga = !empty($_POST['harga']) ? $_POST['harga'] : 0; // Nilai default 0
